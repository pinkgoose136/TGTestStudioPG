...
const QuestionBlock = ({ question, questions, setQuestions, index, scales, type, errors }) => {
    ...
    return (
        <div className="question-block">
            ...
            >
                ...
                <textarea
                    ref={textareaRef}
                    className={`inp ${errors['question-'+question.id] ? 'error' : ''}`}
                            ...
                            return (
                                <div key={answer.id} className="answer-container">
                                    <div className="answer-block">
                                        ...
                                        <>
                                            <textarea
                                                className={`${type === 'simple' ? 'inp1' : 'inp2'} ${errors[answer.id] ? 'error' : ''}`}
                                                style={{
